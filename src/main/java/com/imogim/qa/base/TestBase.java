package com.imogim.qa.base;

import com.imogim.qa.util.TestUtil;
...
public class TestBase {
    ...
    public TestBase(){
        ...
        try {
            prop = new Properties();
            FileInputStream file = new FileInputStream("C:\\Users\\bolas\\IdeaProjects\\imogimTest\\" +
                    "src\\main\\java\\com\\imogim\\qa\\config\\config.properties");
            prop.load(file);
